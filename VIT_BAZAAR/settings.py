"""
Django settings for VIT_BAZAAR project.
...
SECRET_KEY = 'django-insecure-t2tx9h^*m2x8+$!2pnmtt$74h^4em&m@)%miio($^)()w%a2-^'
...
WSGI_APPLICATION = 'VIT_BAZAAR.wsgi.application'
